...
// let sumNum = getSumResult(num1,num2,num3,num4)
// let multiplyNUm = getMultiplyResult(num1,num2,num3,num4)
// let avarageNum = getAvarageResult(num1,num2,num3,num4)
// let minNum = getMinNum(num1,num2,num3,num4)
